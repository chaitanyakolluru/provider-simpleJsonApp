# ====================================================================================
# Setup Project
PROJECT_NAME := provider-simplejsonapp
...
XPKGS = provider-simplejsonapp
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-simplejsonapp: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider simpleJsonApp CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider simpleJsonApp controllers
...
# This target prepares repo for your provider by replacing all "simplejsonapp"
